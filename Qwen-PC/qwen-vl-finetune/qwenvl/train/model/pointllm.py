...
class PointLLMLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig):
        ...
        if self.point_backbone_type == "PointBERT":
            ...
            from qwenvl.train.model.pointbert.point_encoder import PointTransformer
            ...
            # Most provided configs default to xyzrgb (6). Support xyz-only (3) when use_color is False.
            point_bert_config.model.point_dims = 6 if getattr(config, "use_color", False) else 3
