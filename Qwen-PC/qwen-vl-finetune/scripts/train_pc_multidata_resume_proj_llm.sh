...
# ===== 基础路径（可覆盖） =====
# 根目录（整模型分片 + 配置所在处）
MODEL_DIR=${MODEL_DIR:-"/e2e-data/embodied-research-data/large_model/huggingface/hub/Qwen3VL-8B"}
# 继续训练的输出目录
...
POINT_PROJ_CKPT=${POINT_PROJ_CKPT:-"/e2e-data/evad-tech-vla/luzheng/Qwen3-VL-main/outputs/pc_multidata_from_scratch/point_proj_step-5000.bin"}
